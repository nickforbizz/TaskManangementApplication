            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center">
                        ...
                        @can('create feeds')
                        <a href="{{ route('feeds.create') }}" class="btn btn-primary btn-round ml-auto">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="tb_feeds" class="display table table-striped table-hover">
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Name</th>
